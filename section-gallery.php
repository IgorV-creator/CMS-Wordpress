...
<div class="gallery-section" id="gallery-section" <?php if( false == $restau_lite_enable_section ): echo 'style="display: none;"'; endif ?>>
    <div class="gallery-content wow zoomIn" data-wow-delay="300ms">
        <?php
        $restau_lite_gallery_title_serif = get_theme_mod( 'restau_lite_gallery_title_serif', esc_html__( 'Our') );
        $restau_lite_gallery_title = get_theme_mod( 'restau_lite_gallery_title', esc_html__( 'Space') );
        $restau_lite_gallery_text = get_theme_mod( 'restau_lite_gallery_text', esc_html__( 'Learn more about our site') );
        $restau_lite_gallery_link_title = get_theme_mod( 'restau_lite_gallery_link_title', esc_html__( 'Gallery') );
        $restau_lite_gallery_link_url = get_theme_mod( 'restau_lite_gallery_link_url', esc_html__( '#') );
        ?>
        <h3 class="style-title-ya"><?php echo esc_html( $restau_lite_gallery_title_serif ); ?></h3>&nbsp;<h3 class="style-title-ya"><?php echo esc_html( $restau_lite_gallery_title ); ?></h3>
